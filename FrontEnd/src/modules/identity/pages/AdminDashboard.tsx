...
export function AdminDashboard() {
  const [pendientes, setPendientes] = useState<SolicitudVerificacion[]>([])
  ...
  return (
    <div className="tx-dashboard">
      <div className="tx-header">
        ...
        <p className="tx-sub">
          Revisa y modera las solicitudes para ser Reparador Verificado de la comunidad.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="tx-empty">
          ...
          <p>¡Todo al día! No hay usuarios esperando revisión de documentos en este momento.</p>
        </div>
      ) : (
              ...
              <div className="tx-card-main" style={{ borderBottom: 'none' }}>
                <div className="tx-details">
                  <div className="tx-meta-row">
                    ...
                    <span className="tx-mode" style={{ fontFamily: 'var(--mono)' }}>
...
const Clock = ({ size, style }: ClockProps) => (
  <svg
